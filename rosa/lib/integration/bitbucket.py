...
from rosa.lib.integration import GitProvider
...
class Bitbucket(GitProvider):
    ...
    def get_reports_url(self, repo_context):
        ...
        url = f"http://api.bitbucket.org/2.0/repositories/{context.get('repoFullname')}/commit/{context.get('revisionId')}/reports/rosa"
        return url
            ...
            try:
                ...
                rr = requests.put(
                    ...
                    json={
                        ...
                        "logo_url": "https://raw.githubusercontent.com/AppThreat/.github/main/profile/appthreat-logo-small.png",
