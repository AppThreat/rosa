...
import rosa.lib.cis as cis
import rosa.lib.config as config
import rosa.lib.csv_parser as csv_parser
import rosa.lib.xml_parser as xml_parser
from rosa.lib.context import find_repo_details
from rosa.lib.cwe import get_description, get_name
from rosa.lib.issue import issue_from_dict
from rosa.lib.logger import LOG
from rosa.lib.utils import (
    find_path_prefix,
    is_generic_package,
    is_ignored_file,
    to_fingerprint_hash,
            ...
            om.Run(
                automation_details=om.RunAutomationDetails(
                    ...
                    description=om.Message(
                        text="Static Analysis Security Test results using @AppThreat/rosa"
                    ),
                ),
                tool=om.Tool(
                ...
                conversion={
                    "tool": om.Tool(driver=om.ToolComponent(name="@AppThreat/rosa")),
