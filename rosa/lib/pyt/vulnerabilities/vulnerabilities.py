...
from rosa.lib.pyt.analysis.definition_chains import build_def_use_chain
from rosa.lib.pyt.analysis.lattice import Lattice
from rosa.lib.pyt.core.node_types import AssignmentNode, BBorBInode, IfNode, TaintedNode
from rosa.lib.pyt.helper_visitors import CallVisitor, RHSVisitor, VarsVisitor
from rosa.lib.pyt.vulnerabilities.trigger_definitions_parser import Source, parse
from rosa.lib.pyt.vulnerabilities.vulnerability_helper import (
    Sanitiser,
    TriggerNode,
    Triggers,
    VulnerabilityType,
